...
<div class="sidebar">
	<h3><i class="fa fa fa-desktop"></i> &nbsp;RUSDIANTO-KOM</h3>
	<ul><?php
			if ($_SESSION['status']==1) {
				?>
					...
					<li><a id="kategori" href="kategori.php"><i class="fa fa-bars"></i> List Kategori</a></li>
					<li><a id="merk" href="merk.php"><i class="fa fa-bars"></i> List Merk</a></li>
					<!-- <li><a id="supplier" href="supplier.php"><i class="fa fa-truck"></i> Data Supplier</a></li> -->
					<li><a id="tambah_permintaan" href="tambah_permintaan.php"><i class='fa fa-inbox'></i></i> Permintaan Barang</a></li>
					<li><a id="list_permintaan" href="list_permintaan.php"><i class='fa fa-bars'></i></i> List Permintaan</a></li>
