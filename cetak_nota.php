...
function Header()
{
    ...
    $this->cell(30,10,'Jl Kyai Telingsing No. 5 Janggalan Kudus');

    $this->cell(80);
    $this->SetFont('Arial','',10);
    $this->cell(30,10,'Kudus, '.base64_decode($_GET['uuid']).'');
    $this->Line(10,40,200,40);

    $this->Ln(5);
    $this->SetFont('Arial','i',10);
    $this->cell(30,10,'Telp/Fax : (0291)3426888');
    $this->Line(10,40,200,40);
...
$pdf->Output('','RUSDIANTO/'.$filename.'.pdf');
?>
